...
// export 했던 user의 리듀서를 가져온것이다. 이때 handleActions로 쓰고 이름은 안정했기때문에 해당 user 에서 import 하면 이렇게 정해서 쓸수있다
...
const rootReducer = combineReducers({
  ...
  //history 를 만들고 createBrowserHistory()를 넣어준다. 그리고 리듀서를 묶는 구간에 router 에다가 history를 connectRouter로 router와 연결이 되게 하고 스토어에 history 저장.
});
